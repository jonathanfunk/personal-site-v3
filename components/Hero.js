...
const Hero = () => {
	return (
		<section className='min-h-96 px-7 pb-20 pt-32 flex items-center flex-wrap bg-gradient-to-br from-seance-950 to-seance-800 lg:min-h-screen lg:w-1/2 lg:px-20 lg:fixed'>
			<div className='container text-white max-w-xl m-auto lg:m-0'>
